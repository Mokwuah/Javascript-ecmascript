...
function loadQuestions(){
    try{ 
        const data = filesys.readFileSync("questions.json", "utf8")
...
function getRandomQuestions(questions, numQuestions){
    ...
    }// making sure the user cant choose a number greater the number of questions in the bank 
...
//Random quiz generator with JSON :3
